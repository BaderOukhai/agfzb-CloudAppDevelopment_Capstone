...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://baderoukhai-3000.theiadocker-2-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
        ...
        # Render the index page with the dealer names
        return render(request, 'base.html', context)
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://baderoukhai-5000.theiadocker-2-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews?id=15'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://d0c6fba4-de9e-4d5e-9ebb-c481b50fc836-bluemix.cloudantnosqldb.appdomain.cloud/dealerships/dealer-get?dealerId={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://d0c6fba4-de9e-4d5e-9ebb-c481b50fc836-bluemix.cloudantnosqldb.appdomain.cloud/api/review"  # API Cloud Function route
